...
shootCone = 30;//射击瞄准角度 最大360
        */
        ...
        小旋风子弹1 = new BasicBulletType(2.5f, 5, "ctrebirth-yueya") {{
            width = 5f;
            height = 5f;
            lifetime = 60f;
            ...
            fragBullet = new BasicBulletType(2.5f, 5, "ctrebirth-yueya")//分裂的子弹
            {{
                width = 5f;
                height = 5f;
                lifetime = 45f;
        ...
        艺璇 = new BasicBulletType(2.5f,30) {{
         ...
         //   maxRange = 50f;//子弹射程确定覆盖范围。
           ...
           // healPercent = 4f;//修复方块
            ...
            fragBullet = new BasicBulletType(0f, 5, "ctrebirth-yueya")//分裂的子弹
            {{
                width = 15f;
                height = 15f;
                lifetime = 240f;
