...
//方块
public class 资源 {
    public static OreBlock ore钻石混合物, ore石英, ore铝, ore钴;
    public static Item
            爆破弹, 电池, 放射混合物, 放射沙, 钴, 固体放射物, 金, 空壳, 冷冻弹, 钻石矿,
            黎辉水晶, 铝, 铝板, 石英, 水瓶, 碎裂弹, 钛合金, 碳板, 铁, 铁板, 钍电池, 相织硅,
            啸动合金, 硬直弹, 钻石, 钻石混合物,
            物品;
...
//            explosiveness=2;
        ...
        铝 = new Item("铝", Color.valueOf("008B8B")) {{
            localizedName = "铝";
            hardness = 6;
//            explosiveness=2;
            //radioactivity=12.5F;
        ...
        铝板 = new Item("铝板", Color.valueOf("2E8B57")) {{
            localizedName = "铝板";
            // hardness = 4;
//            explosiveness=2;
            //radioactivity=12.5F;
