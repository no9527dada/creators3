...
public class 工厂 {
    ...
    public static Block
            资源转换器_废料, 资源转换器_铜铅, 资源转换器_钛, 资源转换器_钍, 资源转换器_钴, 资源转换器_铝, 资源转换器_塑钢,
            军火库, 水晶复合器, 啸动冲击械, 粒子离心机, 黎辉离心机, 钛合金反应炉, 铝板混合器, 碳板压缩机, 硫粉发生机, 铝板合成机,
    ...
    public static void load() {
        ...
        铝板合成机 = new GenericCrafter("铝板合成机") {{
            localizedName = "铝板合成机";
            consumeItems(with(铁, 1, 铝, 2

            ));
            //  consumeLiquid(Liquids.water, 0.1f);
            consumePower(160 / 60f);
            outputItem = new ItemStack(铝板, 1);
            health = 230;
            itemCapacity = 10;
            size = 2;
            craftTime = 80;
        ...
        铝板混合器 = new GenericCrafter("铝板混合器") {{
            localizedName = "铝板混合器";
            consumeItems(with(铁板, 1, 铝, 5
            ));
            //  consumeLiquid(Liquids.water, 0.1f);
            consumePower(160 / 60f);
            outputItem = new ItemStack(铝板, 5);
            health = 230;
            itemCapacity = 10;
            size = 3;
            craftTime = 120;
...
////-----------
        ...
        资源转换器_铝 = new GenericCrafter("资源转换器-铝") {{
            localizedName = "资源转换器-铝";
            consumeItems(with(
                    plastanium, 3,
                    钴, 2
