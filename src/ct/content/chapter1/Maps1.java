...
public class Maps1 {
    ...
    public static void load() {
        ...
        神秘少女 = new SectorPreset("3神秘少女", Planet1.Planet1, 3) {{
            localizedName = "神秘少女";
        ...
        洞穴躲藏 = new SectorPreset("4洞穴躲藏", Planet1.Planet1, 4) {{
            localizedName = "洞穴躲藏";
        ...
        洞穴深处 = new SectorPreset("5洞穴深处", Planet1.Planet1, 5) {{
            localizedName = "洞穴深处";
        ...
        曲沿通道 = new SectorPreset("6曲沿通道", Planet1.Planet1, 6) {{
            localizedName = "曲沿通道";
        ...
        通道分支 = new SectorPreset("7通道分支", Planet1.Planet1, 7) {{
            localizedName = "通道分支";
        ...
        倾巢而出 = new SectorPreset("8倾巢而出", Planet1.Planet1, 8) {{
            localizedName = "倾巢而出";
        ...
        暗袭兽 = new SectorPreset("9暗袭兽", Planet1.Planet1, 9) {{
            localizedName = "暗袭兽";
