...
import static ct.abe.rebirth.content.others.ItemsSMChuaGong.*;
import static ct.abe.rebirth.content.others.ItemsSMCyeLian.*;
...
public class TechTree4 {
    ...
    private static void techtree1() {
        Planets.Planet4.techTree = TechTree.nodeRoot("重生-工厂/战役", coreT1, true, () -> {
    ...
    private static void itemTechTree() {
        Planets.Planet4.techTree = TechTree.nodeRoot("重生-资源", coreT1, true, () -> {
            //原版
/*            node(黑油精炼台, () -> {
                node(coreT1, () -> {
...
//
    ...
    private static void techtree2() {
        Planets.Planet4.techTree = TechTree.nodeRoot(Core.bundle.format("Planet44"), coreShard, true, () -> {

            SectorPreset mull4 = new SectorPreset("mull4", Planets.Planet4, 0) {{
                localizedName = "未开放";
                captureWave = 10;
                difficulty = 0;
