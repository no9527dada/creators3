...
import static ct.chapter1.Maps1.*;
import static ct.chapter1.Turrets.*;
import static ct.chapter1.Wall1.*;
import static ct.chapter1.WuLiu1.*;
...
public class TechTree1 {
    ...
    public static void load() {
        境界科技研究.load();
        Planet1.Planet1.techTree = TechTree.nodeRoot(Core.bundle.format("Planet11"), core0, true, () -> {
