...
import ct.ahapter.lib.CTRUnitType;
...
//绿色辅助船
     ...
     /*       abilities.add(new SuppressionFieldAbility(){{
        ...
        坦克1 = new CTRTankUnitType("stell","stell"){{
            ...
            ammoType = new ItemAmmoType(Items.copper){{range = 80f;ammoPerItem = 2;}};
            useUnitCap = false;
            logicControllable = false;//逻辑控制
            isEnemy = false;
        ...
        坦克2 = new CTRTankUnitType("locus","locus"){{
            ...
            researchCostMultiplier = 0f;
            ammoType = new ItemAmmoType(Items.copper){{range = 50f;}};
        ...
        蜘蛛5 = new CTRErekirUnitType("collaris","collaris"){{
            ...
            baseLegStraightness = 0.5f;
            useUnitCap = false; isEnemy = false;
            legCount = 8;
            legLength = 30f;
            legForwardScl = 2.1f;
            legMoveSpace = 1.05f;
        ...
        空军4 = new CTRErekirUnitType("quell","quell"){{
            ...
            envDisabled = 0;
            useUnitCap = false;
            lowAltitude = false; isEnemy = false;
            flying = true;
            drag = 0.06f;
            speed = 1.1f;
            rotateSpeed = 3.2f;
