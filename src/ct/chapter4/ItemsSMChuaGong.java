...
public class ItemsSMChuaGong {
    ...
    public static void load(){
        资源炼化器1= new CreatorsMultiCrafter("一级资源炼化器",7){{
            ...
            addRecipe(
                    new CreatorsRecipe.InputContents(ItemStack.with(CTItem.粉烟,1), LiquidStack.with(CTItem.恐油, 3),55f*p1t),
            ...
            addRecipe(
                    new CreatorsRecipe.InputContents(ItemStack.with(CTItem.粉烟,3), LiquidStack.with(CTItem.叹酸, 2),50f*p1t),
        ...
        资源炼化器2= new CreatorsMultiCrafter("二级资源炼化器",7){{
            ...
            addRecipe(
                    new CreatorsRecipe.InputContents(ItemStack.with(CTItem.粉烟,1), LiquidStack.with(CTItem.恐油, 3),55f*p2t),
            ...
            addRecipe(
                    new CreatorsRecipe.InputContents(ItemStack.with(CTItem.粉烟,3), LiquidStack.with(CTItem.叹酸, 2),50f*p2t),
